			...
			<div class="flex justify-between gap-2">
				<div class="flex flex-1 flex-col space-y-1.5">
					...
					<BlurFade class="max-w-[600px] md:text-xl" delay={BLUR_FADE_DELAY}
						>안녕하세요! AI 엔지니어 허태환입니다.<br />
						새로운 도전에 항상 설렘을 느끼며, 늘 더 나은 성장을 위해 노력하고 있습니다. <br />
						좋아하니까, 재밌으니까, 몰입하는 자세로 오늘도 한 걸음씩 나아가고 있어요!</BlurFade
					>
				</div>
			...
			<BlurFade delay={BLUR_FADE_DELAY}>
				<div class="flex flex-col items-center justify-center space-y-4 text-center">
					<div class="space-y-2">
						...
						>
							저의 주요 프로젝트를 소개합니다. <br /> 프로젝트 카드 클릭하면 구체적인 내용을 확인하실
							수 있습니다.
						</p>
					</div>
				</div>
